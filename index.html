<!DOCTYPE html>
<!-- saved from url=(0026)https://roaness.glitch.me/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./Ultraviolet _ Sophisticated Web Proxy_files/index.css">
    <script src="./Ultraviolet _ Sophisticated Web Proxy_files/uv.bundle.js.download" defer=""></script>
    <script src="./Ultraviolet _ Sophisticated Web Proxy_files/uv.config.js.download" defer=""></script>
    <script src="./Ultraviolet _ Sophisticated Web Proxy_files/register-sw.js.download" defer=""></script>
    <script src="./Ultraviolet _ Sophisticated Web Proxy_files/search.js.download" defer=""></script>
    <script src="./Ultraviolet _ Sophisticated Web Proxy_files/index.js.download" defer=""></script>
  ...
  <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
    <div title="Ultraviolet Logo" class="flex-center logo-wrapper header-center">
      <img class="logo" src="./Ultraviolet _ Sophisticated Web Proxy_files/uv.png" alt="Ultraviolet">
      <h1 title="Ultraviolet supports YouTube, GeForce NOW and more! Service by TitaniumNetwork.">
        Ultraviolet | TN
      </h1>
    </div>
    <div title="Ultraviolet uses the power of service-workers and more! Unblock many sites today with Ultraviolet!" class="flex-center desc">
      <p>
    ...
    <footer>
      <a title="Ultraviolet is a web proxy service maintained by TitaniumNetwork!" href="https://github.com/titaniumnetwork-dev">TitaniumNetwork</a>
      ...
      <a title="Massive project partnered with TitaniumNetwork, Ultraviolet being the prime example." href="https://github.com/tomphttp">TompHTTP</a>
      <a title="The official deployment repository for Ultraviolet, a web proxy service which can be used to unblock sites at school and more!" href="https://github.com/titaniumnetwork-dev/Ultraviolet-Node">GitHub</a>
